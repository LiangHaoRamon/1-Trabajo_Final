...
docker-compose up -d
```
Ahora todas la imagenes restante se descargan, el volumen de la base de datos mySQL se crea y se generan todos los contenedores necesarios para que funcione la aplicación. La parte cliente, incluida en el microservicio de API_gateway, será accesible desde la ruta http://localhost:3000 y la documentación con swagger UI en http://localhost:3000/api-docs.
